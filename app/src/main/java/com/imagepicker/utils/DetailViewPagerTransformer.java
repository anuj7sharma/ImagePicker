...
/**
 * Created by anuj on 1/26/2017.
 */

public class DetailViewPagerTransformer implements ViewPager.PageTransformer {
    ...
    public DetailViewPagerTransformer(TransformType transformType) {
